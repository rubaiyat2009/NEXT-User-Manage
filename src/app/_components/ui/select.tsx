...
>(({ className, children, invalid, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            { 'text-destructive border-destructive focus:ring-destructive': invalid },
            className,
        )}
        {...props}
    >
        ...
        <SelectPrimitive.Icon asChild>
            <FontAwesomeIcon icon={faChevronDown} className={cn('opacity-50')} />
    ...
    >
        <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
            <SelectPrimitive.ItemIndicator>
                <FontAwesomeIcon icon={faCheck} className={cn('opacity-0')} />
            </SelectPrimitive.ItemIndicator>
        </span>
